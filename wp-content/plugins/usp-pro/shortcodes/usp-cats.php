...
/*
	...
	Syntax: [usp_category id="" class="aaa,bbb,ccc" label="Post Category" required="yes" cats="" size="3" multiple="no" exclude="" custom=""]
	Attributes:
		...
		combo       = a unique id if using chained/combo fields (must be either 1, 2, 3, 4, or 5)
*/
