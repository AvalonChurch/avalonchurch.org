...
function section_uploads_1_desc() { 
	echo '<p>'. esc_html__('Here are the main settings for file uploads. If in doubt on anything, go with the default option. ', 'usp-pro');
	echo esc_html__('Note: file uploads require proper server configuration. Check out', 'usp-pro') .' <a target="_blank" rel="noopener noreferrer" href="https://plugin-planet.com/usp-pro-troubleshoot-file-upload-issues/">'. esc_html__('this post', 'usp-pro') .'</a> '. esc_html__('for more information.', 'usp-pro') .'</p>'; 
}
...
function section_admin_3_desc() { 
	...
	echo esc_html__('to display dynamic bits of information in your email alerts. Shortcut variables may be used in alert messages and subject lines.', 'usp-pro') .' <a target="_blank" rel="noopener noreferrer" href="https://plugin-planet.com/usp-pro-email-shortcodes/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
