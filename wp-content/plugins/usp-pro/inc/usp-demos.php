...
<p><a href="https://plugin-planet.com/usp-pro-multiple-file-upload-fields/">Learn more about custom Files fields</a> and visit the USP Uploads settings to set the default/global Files options (like min/max files, min/max size, etc.).</p>
